...
%\makeindex{name=All,title=All,intoc}
%\makeindex{name=occasion,title=Feasts,intoc}
%\makeindex{name=Introit,title=Introitus.,intoc}
%%\indexsetup{level=\section,toclevel=section,noclearpage}
%\makeindex{name=Gradual,title=Gradualia.,intoc}
%\makeindex{name=Alleluia,title=Versus Alleluiatici,intoc}
%\makeindex{name=Sequence,title=Sequentiae.,intoc}
%\makeindex{name=Tract,title=Tractus.,intoc}
%\makeindex{name=Offertory,title=Offertoria.,intoc}
%\makeindex{name=Communion,title=Communiones.,intoc}
%\makeindex{name=Antiphon,title=Antiphonae.,intoc}
%\makeindex{name=Hymn,title=Hymni.,intoc}
%\makeindex{name=Responsory,title=Responsoria.,intoc}
%\makeindex[name=,title=Varia.,intoc}
%\makeindex[name= ,title= ,intoc}
...
%%Page Size (rev. 11/8/2011) 5x10 [cf. golden section] -- rev: August 18, 2012: bottom from .5 to .4 in an attempt to reduce the page numbers -- to save a few more pages, you could also revise the \newpage commands in the melody catalogue to account for the greater margins
...
{\initfamily\fontsize{37}{37}\selectfont\textcolor{red} #1}%
}
\newcommand*{\redinit}{\def\greinitialformat##1{%
{\initfamily\fontsize{37}{37}\selectfont\textcolor{red} ##1}%
}}
\newcommand*{\blackinit}{\def\greinitialformat##1{%
{\initfamily\fontsize{37}{37}\selectfont ##1}%
}}
